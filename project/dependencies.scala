...
object Dependencies {
  ...
  val vaadinCompatibilityClientCompiled = "com.vaadin" % "vaadin-compatibility-client-compiled" % vaadinVersion

  val vaadinThemes = "com.vaadin" % "vaadin-compatibility-themes" % vaadinVersion
  ...
  val addonDeps = Seq(
    ...
    vaadinThemes,
    vaadinCompatibilityClientCompiled
  )
