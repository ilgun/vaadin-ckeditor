...
public class CKEditorService {
	...
	/*-{
	 	...
	 	var inPageConfig = @com.github.ilgun.ckeditor.widgetset.client.ui.CKEditorService::convertJavaScriptStringToObject(Ljava/lang/String;)(jsInPageConfig);
		...
		myEditor.on( 'instanceReady', function( ev ) {
    		ev.listenerData.@com.github.ilgun.ckeditor.widgetset.client.ui.CKEditorService.CKEditorListener::onInstanceReady()();
		}, null, listener);
	...
	/*-{
	 	var styles = @com.github.ilgun.ckeditor.widgetset.client.ui.CKEditorService::convertJavaScriptStringToObject(Ljava/lang/String;)(jsStyles);
	...
	/*-{
	 	var definition = @com.github.ilgun.ckeditor.widgetset.client.ui.CKEditorService::convertJavaScriptStringToObject(Ljava/lang/String;)(jsDefinition);
